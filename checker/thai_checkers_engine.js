/* @ts-self-types="./thai_checkers_engine.d.ts" */
 ...
 * @returns {any}
 */
export function analyze(white_pieces, black_pieces, is_black_turn, max_depth, time_limit_ms) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('thai_checkers_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
